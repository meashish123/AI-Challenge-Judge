...
router.post('/', function (req, res, next) {
    ...
    User.findOne().where({
        ...
        if (doc == null) {
                ...
                if (doc2 == null) {
                    ...
                    user.save(function (err) {
                        if (err) {
                            ...
                            res.render('infinitum/register', {error: 'Error while register'});
                        } else {
                    ...
                    res.render('infinitum/register', {error: 'Email already registered'});
            ...
            res.render('infinitum/register', {error: 'Username already in Use'});
        }
    });
