...
public class Main {
    ...
    class Player {
        ...
        private Position move(int[][] grid, Position p) {
            ...
            } else if (p.getY() - 1 >= 0 && grid[p.getX()][p.getY() - 1] == 0) {
                return new Position(p.getX(), p.getY() - 1);
            } else if (p.getX() + 1 < n && grid[p.getX() + 1][p.getY()] == 0) {
                return new Position(p.getX() + 1, p.getY());
            } else if (p.getY() + 1 < m && grid[p.getX()][p.getY() + 1] == 0) {
                return new Position(p.getX(), p.getY() + 1);
            } else if (p.getX() - 1 >= 0 && p.getY() - 1 >= 0 && grid[p.getX() - 1][p.getY() - 1] == 0) {
                return new Position(p.getX() - 1, p.getY() - 1);
            } else if (p.getX() + 1 < n && p.getY() + 1 < m && grid[p.getX() + 1][p.getY() + 1] == 0) {
                return new Position(p.getX() + 1, p.getY() + 1);
            } else if (p.getX() - 1 >= 0 && p.getY() + 1 < m && grid[p.getX() - 1][p.getY() + 1] == 0) {
                return new Position(p.getX() - 1, p.getY() + 1);
            } else if (p.getX() + 1 < n && p.getY() - 1 >= 0 && grid[p.getX() + 1][p.getY() - 1] == 0) {
                return new Position(p.getX() + 1, p.getY() - 1);
            }
